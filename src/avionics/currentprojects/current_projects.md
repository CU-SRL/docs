...
1. [Phoenix Flight Computer](phoenix/phoenix.md)
...
2. [Spaceshot Avionics Bay](avbay.md)
...
3. [Ground Station](groundstation.md)
    - We are currently developing an entire ground station and mission control suite. Looking for new members with experience in
        ...
        - Embedded software
4. [WALRUS Video Streaming](WALRUS.md)
...
5. [Lighthouse Cooperative Radar](lighthouse/lighthouse.md)
